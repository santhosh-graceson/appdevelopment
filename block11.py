    ...
    try:  
        ...
        if n<=160:
            if counter<9:
                ...
                last_awp_value.markdown("<p style='font-size:18px;color: #00008B;font-synthesis: bold;text-align:center;'>{}</p>".format(b[2]), unsafe_allow_html=True)
                last_awp1_value.markdown("<p style='font-size:18px;color: #056608;font-synthesis: bold;text-align:center;'>{}</p>".format(c[2]), unsafe_allow_html=True)
                last_awp2_value.markdown("<p style='font-size:18px;color: #000000;font-synthesis: bold;text-align:center;'>{}</p>".format(b[7]), unsafe_allow_html=True)
                last_awp3_value.markdown("<p style='font-size:18px;color: #36013F;font-synthesis: bold;text-align:center;'>{}</p>".format(d[7],e[7]), unsafe_allow_html=True)
                last_awp4_value.markdown("<p style='font-size:18px;color: #8B4000;font-synthesis: bold;text-align:center;'>{}</p>".format(c[7]), unsafe_allow_html=True)
                last_awp5_value.markdown("<p style='font-size:18px;color: #000000;font-synthesis: bold;text-align:center;'>{}</p>".format(d[2]), unsafe_allow_html=True)
                last_awp6_value.markdown("<p style='font-size:18px;color: #492000;font-synthesis: bold;text-align:center;'>{}</p>".format(e[2]), unsafe_allow_html=True)
