        ...
        if n<=160:
            if counter<9:
                ...
                for i in range(10):
                    ...
                    last_awp6_value.markdown("<p style='font-size:36px;gap: 0.1rem;color: #87CEEB;font-synthesis: bold;text-align:center;'>{}</p>".format(df_Inspiration_Flow), unsafe_allow_html=True)
                    final_time=t.time()
