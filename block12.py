    ...
    try:  
        ...
        if n<=160:
            if counter<9:
                ...
                last_insp_flow_value.markdown("<p style='font-size:18px;color: #8B0000;font-synthesis: bold;text-align:center;'>{}</p>".format(data1[4]), unsafe_allow_html=True)
                last_awp_value.markdown("<p style='font-size:18px;color: #00008B;font-synthesis: bold;text-align:center;'>{}</p>".format(data1[0]), unsafe_allow_html=True)
                last_awp1_value.markdown("<p style='font-size:18px;color: #056608;font-synthesis: bold;text-align:center;'>{}</p>".format(data1[1]), unsafe_allow_html=True)
                last_awp2_value.markdown("<p style='font-size:18px;color: #000000;font-synthesis: bold;text-align:center;'>{}</p>".format(data1[5]), unsafe_allow_html=True)
                last_awp3_value.markdown("<p style='font-size:18px;color: #36013F;font-synthesis: bold;text-align:center;'>{}</p>".format(data1[6]), unsafe_allow_html=True)
                last_awp4_value.markdown("<p style='font-size:18px;color: #8B4000;font-synthesis: bold;text-align:center;'>{}</p>".format(data1[8]), unsafe_allow_html=True)
                last_awp5_value.markdown("<p style='font-size:18px;color: #000000;font-synthesis: bold;text-align:center;'>{}</p>".format(data1[2]), unsafe_allow_html=True)
                last_awp6_value.markdown("<p style='font-size:18px;color: #492000;font-synthesis: bold;text-align:center;'>{}</p>".format(data1[3]), unsafe_allow_html=True)
