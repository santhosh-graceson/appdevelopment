    ...
    try:  
        ...
        if n<=160:
            if counter<9:
                ...
                last_insp_flow_value.markdown("<p style='font-size:18px;color: #8B0000;font-synthesis: bold;text-align:center;'>{}</p>".format(j[-1]), unsafe_allow_html=True)
                last_awp_value.markdown("<p style='font-size:18px;color: #00008B;font-synthesis: bold;text-align:center;'>{}</p>".format(f[-1]), unsafe_allow_html=True)
                last_awp1_value.markdown("<p style='font-size:18px;color: #056608;font-synthesis: bold;text-align:center;'>{}</p>".format(g[-1]), unsafe_allow_html=True)
                ...
                last_awp5_value.markdown("<p style='font-size:18px;color: #000000;font-synthesis: bold;text-align:center;'>{}</p>".format(h[-1]), unsafe_allow_html=True)
                last_awp6_value.markdown("<p style='font-size:18px;color: #492000;font-synthesis: bold;text-align:center;'>{}</p>".format(k[-1]), unsafe_allow_html=True)
